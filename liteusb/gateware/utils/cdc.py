...
def stretch_strobe_signal(m, strobe, *, to_cycles, output=None, domain="sync", allow_delay=False):
    ...
    Parameters:
        ...
        domain    -- If provided, the given domain name will be used in lieu of the sync domain.
    ...
    if allow_delay:
        ...
        setattr(m.d, domain)[delayed_strobe.eq((delayed_strobe << 1) | strobe)]
