...
class DecaUSBSoC(SoCCore):
    ...
    def __init__(self, sys_clk_freq=50e6,
        ...
        **kwargs):
        ...
        # The PLL output clock name is generated by derive_pll_clocks and
        # depends on the number of PLLs in the design; use a wildcard to
        # match it regardless of whether there's one or two PLLs.
        platform.toolchain.additional_sdc_commands += [
            "set_false_path -from [get_clocks {clk50}] -to [get_clocks -include_generated_clocks {*}]",
        ]
