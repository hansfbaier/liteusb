...
from liteusb.tests.utils import LiteUSBUSBTestCase, usb_domain_test_case

from liteusb.gateware.usb.usb2       import USBSpeed
from liteusb.gateware.usb.usb2.reset import USBResetSequencer
from liteusb.gateware.interface.utmi     import UTMIOperatingMode, UTMITerminationSelect

class USBResetSequencerTest(LiteUSBUSBTestCase):
