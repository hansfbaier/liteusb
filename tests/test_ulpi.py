...
from liteusb.tests.utils import LiteUSBTestCase, usb_domain_test_case

from migen import Record
from liteusb.gateware.interface.ulpi import ULPIControlTranslator, ULPIRegisterWindow, ULPIRxEventDecoder, ULPITransmitTranslator

class TestULPIRegisters(LiteUSBTestCase):
...
class ULPIRxEventDecoderTest(LiteUSBTestCase):
...
class ControlTranslatorTest(LiteUSBTestCase):
...
class ULPITransmitTranslatorTest(LiteUSBTestCase):
    USB_CLOCK_FREQUENCY=60e6
    SYNC_CLOCK_FREQUENCY=None
