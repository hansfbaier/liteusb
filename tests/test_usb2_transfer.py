...
class USBInTransferManagerTest(LiteUSBUSBTestCase):
    ...
    def initialize_signals(self):
        ...
        # And pretend that our host is always targeting our endpoint.
    ...
    def test_normal_transfer(self):
        ...
        # Before we do anything, we shouldn't have anything on our output stream.
